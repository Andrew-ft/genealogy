    ...
    <div class="container">
        ...
        <form action="/register" method="POST" novalidate>
            <div class="form-group">
                ...
                <input type="text" name="username" value="<?php echo htmlspecialchars($oldInput['username'] ?? ''); ?>">
            </div>

            <div class="form-group">
                <label>Email</label>
                <input type="text" name="email" value="<?php echo htmlspecialchars($oldInput['email'] ?? ''); ?>">
            </div>
